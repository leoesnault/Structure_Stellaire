...
erreur[0]=max(w_exactm20-w_calcm20)
erreur[1]=max(w_exactm10-w_calcm10)
erreur[2]=max(w_exactm05-w_calcm05)
erreur[3]=max(w_exact00-w_calc00)
erreur[4]=max(w_exactp05-w_calcp05)
erreur[5]=max(w_exactp10-w_calcp10)
erreur[6]=max(w_exactp20-w_calcp20)
